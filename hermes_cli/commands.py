...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("quota", "Check AI subscription usage", "Session",
               gateway_only=True, args_hint="[--force]"),
    CommandDef("cl", "Compact context breakdown", "Session",
               gateway_only=True, args_hint="[-v|--verbose]"),
